...
!function (t, e) {
    ...
    function D(t, e) {
        ...
        ["encode", "decode", "equals", "$normalize"].forEach(function (e) {
            ...
            a[e] = n(r)
        }), he(this, {dynamic: t.dynamic, name: t.name, pattern: t.pattern, inherit: t.inherit, is: i(t.is.bind(t), !0), $arrayMode: e})
    }
    ...
    function F(t) {
        ...
        return t = Ye(t) && {value: t} || t, e.__cacheable = !0, he(t, {$$fn: c(t.value) ? t.value : e})
    }
    ...
    function N(e, r, n, i, o) {
        ...
        return e.type instanceof Qe ? e.type : o.type(e.type)
    }
    ...
    function L(t, e, r, n) {
        ...
        return i = te(t.replace) ? t.replace : [], Zt(n) && i.push({from: n, to: void 0}), o = b(i, jt("from")), $(a, function (t) {
    ...
    function rt(t) {
        var e = function (t) {
            ...
            return new rr(r(t), t.resolveFn, t.deps, t.policy)
        }], [jt("useFactory"), function (t) {
            return new rr(r(t), t.useFactory, t.deps || t.dependencies, t.policy)
        }], [jt("useClass"), function (t) {
            return new rr(r(t), function () {
            ...
            return new rr(r(t), f, [t.useExisting], t.policy)
        }]]), o = s([[i(jt("val"), Zt), function (t) {
            return new rr(t.token, f, [t.val], t.policy)
        }], [i(jt("val"), te), function (t) {
            return new rr(t.token, P(t.val), t.val.slice(0, -1), t.policy)
        }], [i(jt("val"), Kt), function (t) {
            return new rr(t.token, t.val, e(t.val), t.policy)
        }]]), a = s([[Ft(rr), function (t) {
            return t
        }], [function (t) {
    ...
    function it(t, e, r, n) {
        return "/" === n ? t : e ? mr(n) + t : r ? n.slice(1) + t : t
    }

    function ot(t) {
        if (!(Kt(t) || Zt(t) || Ft(Be)(t) || Be.isDef(t))) throw new Error("'handler' must be a string, function, TargetState, or have a state: 'newtarget' property");
        return Kt(t) ? t : Ut(t)
    }

    function at(t) {
        t.addResolvable({
            token: Xr, deps: [], resolveFn: function () {
                return t.router
            }, data: t.router
        }, ""), t.addResolvable({
            token: lr, deps: [], resolveFn: function () {
                return t
            }, data: t
        }, ""), t.addResolvable({
    ...
    function lt(t) {
        var e = function (t) {
            return t || ""
        }, r = yr(t).map(e), n = r[0], i = r[1], o = gr(n).map(e);
    ...
    function pt(t) {
        return ae.$injector = Vn, ae.$q = On, {
            name: "vanilla.services", $q: On, $injector: Vn, dispose: function () {
                return null
            }
        }
    }
    ...
    function dt() {
        var t = null;
        return function (e, r) {
            return t = t || ae.$injector.get("$templateFactory"), [new ti(e, r, t)]
        }
    }

    function vt(t) {
        if (!t.parent) return {};
        var e = ["controller", "controllerProvider", "controllerAs", "resolveAs"], r = ["component", "bindings", "componentProvider"],
            n = ["templateProvider", "templateUrl", "template", "notify", "async"].concat(e), i = r.concat(n);
        if (zt(t.views) && Zn(i, t)) throw new Error("State '" + t.name + "' has a 'views' object. It cannot also have \"view properties\" at the state level.  Move the following properties into a view (in the 'views' object):  " + i.filter(function (e) {
            return zt(t[e])
        }).join(", "));
        var o = {}, a = t.views || {$default: g(t, i)};
        return le(a, function (e, i) {
            if (i = i || "$default", Zt(e) && (e = {component: e}), e = he({}, e), Zn(r, e) && Zn(n, e)) throw new Error("Cannot combine: " + r.join("|") + " with: " + n.join("|") + " in stateview: '" + i + "@" + t.name + "'");
            e.resolveAs = e.resolveAs || "$resolve", e.$type = "ng1", e.$context = t, e.$name = i;
            var a = Mr.normalizeUIViewTarget(e.$context, e.$name);
    ...
    function mt(t) {
        ...
        return e.map(ri).reduce(Re, [])
    }

    function yt(t) {
        function e(t, e, n, i, o, a) {
            return r._runtimeServices(i, t, n, e), delete pi.router, delete pi.$get, pi
        }

        (pi = this.router = new Xr).stateProvider = new ii(pi.stateRegistry, pi.stateService), pi.stateRegistry.decorator("views", vt), pi.stateRegistry.decorator("onExit", oi("onExit")), pi.stateRegistry.decorator("onRetain", oi("onRetain")), pi.stateRegistry.decorator("onEnter", oi("onEnter")), pi.viewService._pluginapi._viewConfigFactory("ng1", dt());
        var r = pi.locationService = pi.locationConfig = new ai(t);
        return ai.monkeyPatchPathParameterType(pi), pi.router = pi, pi.$get = e, e.$inject = ["$location", "$browser", "$sniffer", "$rootScope", "$http", "$templateCache"], pi
    }
    ...
    function bt(t) {
        var e = "[object SVGAnimatedString]" === Object.prototype.toString.call(t.prop("href")), r = "FORM" === t[0].nodeName;
        ...
        return {
            restrict: "ECA", priority: -400, compile: function (i) {
                ...
                return i.empty(), function (i, c) {
                    ...
                    var l = f.$cfg || {viewDecl: {}, getTemplate: e.noop}, h = l.path && new sr(l.path);
                    c.html(l.getTemplate(c, h) || a), Me.traceUIViewFill(f.$uiView, c.html());
                    var p = t(c.contents()), d = l.controller, v = u(l), m = s(l), y = h && mi(h);
                    if (i[m] = y, d) {
                    ...
                    if (Zt(l.viewDecl.component)) var _ = l.viewDecl.component, w = G(_), $ = new RegExp("^(x-|data-)?" + w + "$", "i"),
                        S = i.$watch(function () {
    ...
    function Ot(t, e, r, n, i) {
        !Kt(r.$onInit) || i.viewDecl.component && wi || r.$onInit();
        var o = P(i.path).state.self, a = {bind: r};
        if (Kt(r.uiOnParamsChanged)) {
            var u = new sr(i.path).getResolvable("$transition$").data;
    ...
    var xt = angular, It = e && e.module ? e : xt, jt = function (t) {
        ...
        se = ue.angular || {}, ce = se.fromJson || JSON.parse.bind(JSON), fe = se.toJson || JSON.stringify.bind(JSON), le = se.forEach || function (t, e, r) {
    ...
    }, De = Kt(console.table) ? console.table.bind(console) : console.log.bind(console);
    !function (t) {
        t[t.RESOLVE = 0] = "RESOLVE", t[t.TRANSITION = 1] = "TRANSITION", t[t.HOOK = 2] = "HOOK", t[t.UIVIEW = 3] = "UIVIEW", t[t.VIEWCONFIG = 4] = "VIEWCONFIG"
    }(t.Category || (t.Category = {}));
    var Fe = At("$id"), Ne = At("router.$id"), Ue = function (t) {
        return "Transition #" + Fe(t) + "-" + Ne(t)
    }, Le = function () {
        function e() {
        ...
        return e.prototype._set = function (e, r) {
            ...
            this.enabled(t.Category.TRANSITION) && console.log(Ue(e) + ": Started  -> " + J(e))
        }, e.prototype.traceTransitionIgnored = function (e) {
            this.enabled(t.Category.TRANSITION) && console.log(Ue(e) + ": Ignored  <> " + J(e))
        }, e.prototype.traceHookInvocation = function (e, r, n) {
            if (this.enabled(t.Category.HOOK)) {
                var i = At("traceData.hookType")(n) || "internal", o = At("traceData.context.state.name")(n) || At("traceData.context")(n) || "unknown",
                    a = W(e.registeredHook.callback);
                console.log(Ue(r) + ":   Hook -> " + i + " context: " + o + ", " + M(200, a))
            }
        }, e.prototype.traceHookResult = function (e, r, n) {
            this.enabled(t.Category.HOOK) && console.log(Ue(r) + ":   <- Hook returned: " + M(200, J(e)))
        }, e.prototype.traceResolvePath = function (e, r, n) {
            this.enabled(t.Category.RESOLVE) && console.log(Ue(n) + ":         Resolving " + e + " (" + r + ")")
        }, e.prototype.traceResolvableResolved = function (e, r) {
            this.enabled(t.Category.RESOLVE) && console.log(Ue(r) + ":               <- Resolved  " + e + " to: " + M(200, J(e.data)))
        }, e.prototype.traceError = function (e, r) {
            this.enabled(t.Category.TRANSITION) && console.log(Ue(r) + ": <- Rejected " + J(r) + ", reason: " + e)
        }, e.prototype.traceSuccess = function (e, r) {
            this.enabled(t.Category.TRANSITION) && console.log(Ue(r) + ": <- Success  " + J(r) + ", final state: " + e.name)
    ...
    var Be = function () {
    ...
    }(), Ge = {current: l, transition: null, traceData: {}, bind: null}, We = function () {
        function e(e, r, n, i) {
            var o = this;
            ...
            }, this.options = m(i, Ge), this.type = n.eventType
        }
        ...
        return e.prototype.logError = function (t) {
            ...
            if (!e._deregistered) {
                ...
                if (r) return r;
                var n = this.options;
                Me.traceHookInvocation(this, this.transition, n);
                var i = function (r) {
            ...
            }) : (Me.traceHookResult(t, this.transition, this.options), !1 === t ? He.aborted("Hook aborted transition").toPromise() : Ft(Be)(t) ? He.redirected(t).toPromise() : void 0))
            ...
            return i.map(function (i) {
                return i.matches(n)[e.criteriaMatchPath.name].map(function (n) {
                    var a = he({bind: i.bind, traceData: {hookType: e.name, context: n}}, o),
                        u = e.criteriaMatchPath.scope === t.TransitionHookScope.STATE ? n.state.self : null, s = new We(r, u, i, a);
    ...
    }(), Ke = Object.prototype.hasOwnProperty, Ye = function (t) {
        return 0 === ["value", "type", "squash", "array", "dynamic"].filter(Ke.bind(t || {})).length
    };
    !function (t) {
    ...
    var Ze = function () {
            function e(e, r, n, i, o) {
                ...
                var u = void 0 !== n.value || i === t.DefType.SEARCH, s = zt(n.dynamic) ? !!n.dynamic : !!r.dynamic, c = zt(n.raw) ? !!n.raw : !!r.raw,
                    f = U(n, u, o.defaultSquashPolicy()), l = L(n, a, u, f), h = zt(n.inherit) ? !!n.inherit : !!r.inherit;
                he(this, {id: e, type: r, location: i, isOptional: u, dynamic: s, raw: c, squash: f, replace: l, inherit: h, array: a, config: n})
            }
            ...
            return t.prototype.applyRawParams = function (t) {
                ...
                return Ze.changed(r, this.paramValues, t.paramValues)
            }, t.clone = function (e) {
                return new t(e)
            }, t
        }(), tr = function () {
            ...
            return t.makeTargetState = function (t, e) {
                var r = P(e).state;
                return new Be(t, r, e.map(jt("paramValues")).reduce(_e, {}), {})
            }, t.buildPath = function (t) {
                var e = t.params();
                return t.$state().path.map(function (t) {
                    return new Xe(t).applyRawParams(e)
                })
                ...
                return e.map(function (e) {
                    ...
                    return new Xe(e.state).applyRawParams(s)
                })
        ...
        }(), er = {when: "LAZY", async: "WAIT"}, rr = function () {
            ...
            return t.prototype.getPolicy = function (t) {
                ...
                return {when: e.when || r.when || er.when, async: e.async || r.async || er.async}
            }, t.prototype.resolve = function (t, e) {
                var r = this, n = ae.$q, i = t.findNode(this), o = i && i.state, a = "RXWAIT" === this.getPolicy(o).async ? function (t) {
                    var e = t.cache(1);
                ...
                return this.promise = n.when().then(function () {
                    ...
                    return r.data = t, r.resolved = !0, Me.traceResolvableResolved(r, e), r.data
                })
        ...
        }(), nr = {when: {LAZY: "LAZY", EAGER: "EAGER"}, async: {WAIT: "WAIT", NOWAIT: "NOWAIT", RXWAIT: "RXWAIT"}}, ir = nr.when, or = [ir.EAGER, ir.LAZY],
        ar = [ir.EAGER], ur = "Native Injector", sr = function () {
            function t(t) {
                this._path = t
            }
            ...
            return t.prototype.getTokens = function () {
                ...
                return new t(tr.subPath(this._path, function (t) {
                    return t.state === e
                }))
                ...
                var r = this;
                void 0 === t && (t = "LAZY");
                var n = (ve(or, t) ? t : "LAZY") === nr.when.EAGER ? ar : or;
                Me.traceResolvePath(this._path, t, e);
                var i = function (t, e) {
                    return function (n) {
                        return ve(t, r.getPolicy(n)[e])
                    }
                }, o = this._path.reduce(function (t, o) {
                    var a = o.resolvables.filter(i(n, "when")), u = a.filter(i(["NOWAIT"], "async")), s = a.filter(Ht(i(["NOWAIT"], "async"))),
                        c = r.subContext(o.state), f = function (t) {
                ...
                return this._injector || (this._injector = new cr(this))
                ...
                var e = this, r = this.findNode(t), n = (tr.subPath(this._path, function (t) {
                    return t === r
            ...
            function t(t) {
                this.context = t, this.native = this.get(ur) || ae.$injector
            }
        ...
        }(), fr = jt("self"), lr = function () {
            function e(e, r, n) {
                var i = this;
                if (this._deferred = ae.$q.defer(), this.promise = this._deferred.promise, this._registeredHooks = {}, this._hookBuilder = new Je(this), this.isActive = function () {
                ...
                var o = tr.buildToPath(e, r);
                this._treeChanges = tr.treeChanges(e, o, this._options.reloadState), this.createTransitionHookRegFns();
                var a = this._hookBuilder.buildHooksForPhase(t.TransitionHookPhase.CREATE);
                We.invokeHooks(a, function () {
                    return null
            ...
            return e.prototype.onBefore = function (t, e, r) {
                ...
                tr.applyViewConfigs(t.transitionService.$view, this._treeChanges.to, e)
                ...
                return t instanceof e ? this.is({to: t.$to().name, from: t.$from().name}) : !(t.to && !A(this.$to(), t.to) || t.from && !A(this.$from(), t.from))
                ...
                return b(this._treeChanges.entering, jt("state")).map(fr)
            }, e.prototype.exiting = function () {
                return b(this._treeChanges.exiting, jt("state")).map(fr).reverse()
            }, e.prototype.retained = function () {
                return b(this._treeChanges.retained, jt("state")).map(fr)
                ...
                t = t.withOptions(i, !0);
                var o = this.router.transitionService.create(this._treeChanges.from, t), a = this._treeChanges.entering, u = o._treeChanges.entering;
                return tr.matching(u, a, tr.nonDynamicParams).filter(Ht(function (t) {
                    return function (e) {
                ...
                var e = this, r = We.runAllHooks, n = function (t) {
                    return e._hookBuilder.buildHooksForPhase(t)
                }, i = n(t.TransitionHookPhase.BEFORE);
                return We.invokeHooks(i, function () {
                    var t = e.router.globals;
                    return t.lastStartedTransitionId = e.$id, t.transition = e, t.transitionHistory.enqueue(e), Me.traceTransitionStart(e), ae.$q.when(void 0)
                }).then(function () {
                    var e = n(t.TransitionHookPhase.RUN);
                    return We.invokeHooks(e, function () {
                        return ae.$q.when(void 0)
                    })
                }).then(function () {
                    Me.traceSuccess(e.$to(), e), e.success = !0, e._deferred.resolve(e.to()), r(n(t.TransitionHookPhase.SUCCESS))
                }, function (i) {
                    Me.traceError(i, e), e.success = !1, e._deferred.reject(i), e._error = i, r(n(t.TransitionHookPhase.ERROR))
                }), this.promise
        ...
        }(), hr = null, pr = function (t) {
            var e = He.isRejectionPromise;
            return (hr = hr || s([[Ht(zt), Ut("undefined")], [Jt, Ut("null")], [ie, Ut("[Promise]")], [e, function (t) {
                return t._transitionRejection.toString()
            }], [Ft(He), u("toString")], [Ft(lr), u("toString")], [Ft(rr), u("toString")], [c, W], [Ut(!0), f]]))(t)
        }, dr = function (t) {
            return function (e) {
                if (!e) return ["", ""];
                var r = e.indexOf(t);
        ...
        }, vr = new RegExp("^(?:[a-z]+:)?//[^/]+/"), mr = function (t) {
            return t.replace(/\/[^/]*$/, "")
        }, yr = dr("#"), gr = dr("?"), _r = dr("="), wr = function (t) {
            return t ? t.replace(/^#/, "") : ""
        }, $r = function () {
            function t() {
            ...
            return t.prototype.dispose = function () {
                ...
                return this.types[t] = new Qe(he({name: t}, e)), r && (this.typeQueue.push({name: t, def: r}), this.enqueue || this._flushTypeQueue()), this
    ...
    !function () {
        ...
        he($r.prototype, {
            string: t({}), path: t({pattern: /[^/]*/}), query: t({}), hash: t({inherit: !1}), int: t({
                decode: function (t) {
                    return parseInt(t, 10)
                }, is: function (t) {
                ...
                }, pattern: /[0-9]{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[1-2][0-9]|3[0-1])/, capture: /([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])/
            }), json: t({encode: fe, decode: ce, is: Ft(Object), equals: pe, pattern: /[^/]*/}), any: t({
    ...
    var Sr, br = function () {
        ...
        return function (r) {
            ...
            var i = Rr(n.url), o = r.parent, a = i ? t.compile(i.val, {
        ...
        return function (e) {
            var r = e.url && e.url.parameters({inherit: !1}) || [], n = $e(we(_(e.params || {}, r.map(jt("id"))), function (e, r) {
        ...
        function t(t, e) {
            ...
            this.builders = {
                name: [Y], self: [Z], parent: [function (e) {
                    return i(e) ? null : t.find(r.parentName(e)) || n()
                }], data: [X], url: [Er(e, n)], navigable: [Tr(i)], params: [Cr(e.paramFactory)], views: [], path: [tt], includes: [et], resolvables: [rt]
            }
        }
        ...
        function t(t) {
            this._router = t, this.states = {}, this.listeners = [], this.matcher = new kr(this.states), this.builder = new Pr(this.matcher, t.urlMatcherFactory), this.stateQueue = new Or(this, t.urlRouter, this.states, this.builder, this.listeners), this._registerRoot()
        }
        ...
        function e(t, r, n, i) {
            ...
            for (var a, u, s, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, h = 0, p = [], d = function (r) {
                ...
                return {
                    id: i, regexp: a, cfg: o.config.params[i], segment: t.substring(h, e.index), type: a ? r.type(a) || function (t) {
        ...
        return e.prototype.append = function (t) {
            ...
            var o = Ir(this._cache, "pattern", function () {
            ...
            var n = function (t) {
                ...
                return t._cache.weights = t._cache.weights || n(t).map(function (t) {
                    return "/" === t ? 1 : Zt(t) ? 2 : t instanceof Ze ? 3 : void 0
                })
            }, o = i(t), a = i(r);
            !function (t, e, r) {
        ...
        function e() {
            var e = this;
            this.paramTypes = new $r, this._isCaseInsensitive = !1, this._isStrictMode = !0, this._defaultSquashPolicy = !1, this._getConfig = function (t) {
                return he({strict: e._isStrictMode, caseInsensitive: e._isCaseInsensitive}, t)
            }, this.paramFactory = {
                fromConfig: function (r, n, i) {
                    return new Ze(r, n, i, t.DefType.CONFIG, e)
                }, fromPath: function (r, n, i) {
                    return new Ze(r, n, i, t.DefType.PATH, e)
                }, fromSearch: function (r, n, i) {
                    return new Ze(r, n, i, t.DefType.SEARCH, e)
                }
            }, he(this, {UrlMatcher: Vr, Param: Ze})
        }
        ...
        return e.prototype.caseInsensitive = function (t) {
            ...
            return new Vr(t, this.paramTypes, this.paramFactory, this._getConfig(e))
        }, e.prototype.isMatcher = function (t) {
            if (!Xt(t)) return !1;
            var e = !0;
            return le(Vr.prototype, function (r, n) {
        ...
        return t.prototype.compile = function (t) {
            ...
            var r = e;
            Zt(e) && (e = this.router.urlMatcherFactory.compile(e)), Ft(Vr)(e) && (r = function (t) {
                return e.format(t)
            });
            var n = {
        ...
        return t.urlMatcher && e.urlMatcher ? Vr.compare(t.urlMatcher, e.urlMatcher) : 0
    }, Ur = function (t, e) {
    ...
    Sr = function (t, e) {
        var r = Dr(t, e);
        return 0 !== r ? r : 0 !== (r = Fr(t, e)) ? r : 0 !== (r = Nr(t, e)) ? r : Ur(t, e)
    };
    var Lr = function () {
            function t(e) {
                this._sortFn = Sr, this._rules = [], this.interceptDeferred = !1, this._id = 0, this._sorted = !1, this._router = e, this.urlRuleFactory = new Hr(e), h(Ut(t.prototype), this, Ut(this))
            }
            ...
            return t.prototype.dispose = function () {
                ...
                if (!t || !t.defaultPrevented) {
                    var e = this._router, r = e.urlService, n = e.stateService, i = {path: r.path(), search: r.search(), hash: r.hash()}, o = this.match(i);
                    s([[Zt, function (t) {
                        return r.url(t, !0)
                    }], [Be.isDef, function (t) {
                ...
                var e = this;
                if (!Hr.isUrlRule(t)) throw new Error("invalid rule");
            ...
            return t.prototype._rootViewContext = function (t) {
                ...
                Me.traceViewServiceEvent("<- Removing", t), me(this._viewConfigs, t)
            }, t.prototype.activateViewConfig = function (t) {
                Me.traceViewServiceEvent("-> Registering", t), this._viewConfigs.push(t)
                ...
                Me.traceViewSync(a), a.forEach(function (t) {
                    var e = t[0], r = t[1];
                    -1 !== n._uiViews.indexOf(e) && e.configUpdated(r)
                })
            }, t.prototype.registerUIView = function (t) {
                Me.traceViewServiceUIViewEvent("-> Registering", t);
                var e = this._uiViews;
                return e.filter(function (e) {
                    return e.fqn === t.fqn && e.$type === t.$type
                }).length && Me.traceViewServiceUIViewEvent("!!!! duplicate uiView named:", t), e.push(t), this.sync(), function () {
                    -1 !== e.indexOf(t) ? (Me.traceViewServiceUIViewEvent("<- Deregistering", t), me(e)(t)) : Me.traceViewServiceUIViewEvent("Tried removing non-registered uiView", t)
                }
                ...
                void 0 === e && (e = "");
                var r = e.split("@"), n = r[0] || "$default", i = Zt(r[1]) ? r[1] : "^", o = /^(\^(?:\.\^)*)\.(.*$)/.exec(n);
            ...
            function t() {
                this.params = new br, this.lastStartedTransitionId = -1, this.transitionHistory = new Ve([], 1), this.successfulTransitions = new Ve([], 1)
            }
        ...
        }, Wr = ["url", "path", "search", "hash", "onChange"], zr = ["port", "protocol", "host", "baseHref", "html5Mode", "hashPrefix"],
        Jr = ["type", "caseInsensitive", "strictMode", "defaultSquashPolicy"], Qr = ["sort", "when", "initial", "otherwise", "rules", "rule", "removeRule"],
        Kr = ["deferIntercept", "listen", "sync", "match"], Yr = function () {
            function t(t, e) {
                ...
                h(n, this.config, n, zr, e);
                var i = function () {
                    return t.urlMatcherFactory
                };
                h(i, this.config, i, Jr);
                var o = function () {
                    return t.urlRouter
                };
                h(o, this.rules, o, Qr), h(o, this, o, Kr)
            }
            ...
            }, t.locationServiceStub = Gr(Wr), t.locationConfigStub = Gr(zr), t
        }(), Zr = 0, Xr = function () {
            function t(t, e) {
            ...
            function e(e) {
                if (e) return e instanceof Be ? e : Zt(e) ? n.target(e, t.params(), t.options()) : e.state || e.params ? n.target(e.state || t.to(), e.params || t.params(), t.options()) : void 0
            }
        ...
        }, nn = ut("onExit"), on = function (t) {
            return t.onExit({
                exiting: function (t) {
                    return !!t.onExit
                }
            }, nn)
        }, an = ut("onRetain"), un = function (t) {
            return t.onRetain({
                retained: function (t) {
                    return !!t.onRetain
                }
            }, an)
        }, sn = ut("onEnter"), cn = function (t) {
            return t.onEnter({
                entering: function (t) {
                    return !!t.onEnter
                }
            ...
            return new sr(t.treeChanges().to).resolvePath("EAGER", t).then(l)
        }, ln = function (t) {
            return t.onStart({}, fn, {priority: 1e3})
        }, hn = function (t, e) {
            return new sr(t.treeChanges().to).subContext(e.$$state()).resolvePath("LAZY", t).then(l)
        }, pn = function (t) {
            return t.onEnter({entering: Ut(!0)}, hn, {priority: 1e3})
        }, dn = function (t) {
            ...
            return t.onSuccess({}, wn, {priority: 9999})
        }, Sn = function (t) {
            ...
            return function (t, e, r, n, i, o, a, u) {
                void 0 === i && (i = !1), void 0 === o && (o = We.HANDLE_RESULT), void 0 === a && (a = We.REJECT_ERROR), void 0 === u && (u = !1), this.name = t, this.hookPhase = e, this.hookOrder = r, this.criteriaMatchPath = n, this.reverseSort = i, this.getResultHandler = o, this.getErrorHandler = a, this.synchronous = u
            }
        }(), En = function (t) {
            ...
            return e.prototype.onCreate = function (t, e, r) {
                ...
                return new lr(t, e, this._router)
            }, e.prototype._defineCoreEvents = function () {
                var e = t.TransitionHookPhase, r = We, n = this._criteriaPaths;
                ...
                void 0 === i && (i = !1), void 0 === o && (o = We.HANDLE_RESULT), void 0 === a && (a = We.REJECT_ERROR), void 0 === u && (u = !1);
                var s = new Rn(t, e, r, n, i, o, a, u);
                ...
                t.addCoreResolves = tn(this), t.ignored = En(this), t.invalid = Tn(this), t.redirectTo = rn(this), t.onExit = on(this), t.onRetain = un(this), t.onEnter = cn(this), t.eagerResolve = ln(this), t.lazyResolve = pn(this), t.loadViews = vn(this), t.activateViews = yn(this), t.updateGlobals = _n(this), t.updateUrl = $n(this), t.lazyLoad = bn(this)
            }, e
        }(), kn = function () {
            function e(t) {
            ...
            return Object.defineProperty(e.prototype, "transition", {
                ...
                var n = this, i = tr.makeTargetState(this.router.stateRegistry, t), o = this.router.globals, a = function () {
                    return o.transitionHistory.peekTail()
                }, u = a(), s = new Ve(this.invalidCallbacks.slice()), c = new sr(t).injector(), f = function (t) {
                    if (t instanceof Be) {
                        var e = t;
                ...
                var n = m(r, {relative: this.$current, inherit: !0}, Cn);
                ...
                return new Be(this.router.stateRegistry, t, e, r)
            }, e.prototype.getCurrentPath = function () {
                var t = this, e = this.router.globals.successfulTransitions.peekTail();
                return e ? e.treeChanges().to : [new Xe(t.router.stateRegistry.root())]
                ...
                var c = function (e) {
                    return function (r) {
                        if (r instanceof He) {
                            ...
                            var u = r.detail;
                            if (r.type === t.RejectType.SUPERSEDED && r.redirected && u instanceof Be) {
                                var s = e.redirect(u);
                ...
                if (zt(n)) {
                    ...
                    return Ze.equals(i, Ze.values(i, e), this.params)
                }
                ...
                if (zt(i)) {
                    ...
                    return Ze.equals(a, Ze.values(a, e), this.params)
                }
                ...
                var n = this.getCurrentPath(), i = tr.makeTargetState(this.router.stateRegistry, n);
            ...
            when: function (t) {
                ...
                if (Xt(t)) {
                    ...
                    return On.all(e).then(function (t) {
                        return t.reduce(function (t, e) {
        ...
        }, xn = {}, In = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, jn = /([^\s,]+)/g, Vn = {
            get: function (t) {
                return xn[t]
            }, has: function (t) {
                return null != Vn.get(t)
            }, invoke: function (t, e, r) {
                var n = he({}, xn, r || {}), i = Vn.annotate(t), o = ke(function (t) {
                ...
                var e = t.toString().replace(In, "");
                return e.slice(e.indexOf("(") + 1, e.indexOf(")")).match(jn) || []
            }
        }, An = function (t, e) {
            var r = e[0], n = e[1];
            return t.hasOwnProperty(r) ? te(t[r]) ? t[r].push(n) : t[r] = [t[r], n] : t[r] = n, t
        }, Hn = function (t) {
            return t.split("&").filter(f).map(_r).reduce(An, {})
        }, qn = function (t) {
            ...
            return Fn(e, t), e.prototype._get = function () {
                return wr(this._location.hash)
            ...
            return Mn(e, t), e.prototype._getBasePrefix = function () {
                return mr(this._config.baseHref())
        ...
        }(), zn = ht("vanilla.hashBangLocation", !1, Nn, Wn), Jn = ht("vanilla.pushStateLocation", !0, Bn, Wn), Qn = ht("vanilla.memoryLocation", !1, Ln, Gn),
        Kn = function () {
            function t() {
            }
            ...
            PathUtils: tr,
            resolvePolicies: nr,
            defaultResolvePolicy: er,
            Resolvable: rr,
            NATIVE_INJECTOR_TOKEN: ur,
            ResolveContext: sr,
            resolvablesBuilder: rt,
            StateBuilder: Pr,
            StateObject: Mt,
            StateMatcher: kr,
            StateQueueManager: Or,
            StateRegistry: xr,
            StateService: kn,
            TargetState: Be,
            ...
            Transition: lr,
            TransitionHook: We,
            TransitionEventType: Rn,
            defaultTransOpts: Cn,
            TransitionService: Pn,
            UrlMatcher: Vr,
            ...
            return t.prototype.load = function () {
                var t = this, e = ae.$q, r = new sr(this.path), n = this.path.reduce(function (t, e) {
                    return he(t, e.paramValues)
                ...
                return e.all(i).then(function (e) {
                    return Me.traceViewServiceEvent("Loaded", t), t.controller = e.controller, he(t, e.template), t
                })
            ...
            return ni(Xt(t.bindToController) ? t.bindToController : t.scope)
        }, ni = function (t) {
            return Object.keys(t || {}).map(function (e) {
                return [e, /^([=<@&])[?]?(.*)/.exec(t[e])]
            }).filter(function (t) {
            ...
            return function (e, r) {
                ...
                return n ? function (t, e) {
                    var r = new sr(t.treeChanges(i)), o = he(mi(r), {$state$: e, $transition$: t});
    ...
    var si = It.module("ui.router.init", []), ci = It.module("ui.router.util", ["ng", "ui.router.init"]),
        fi = It.module("ui.router.router", ["ui.router.util"]), li = It.module("ui.router.state", ["ui.router.router", "ui.router.util", "ui.router.angular1"]),
        hi = It.module("ui.router", ["ui.router.init", "ui.router.state", "ui.router.angular1"]), pi = (It.module("ui.router.compat", ["ui.router"]), null);
    ...
    _t.$inject = ["$rootScope"], si.provider("$uiRouter", yt), fi.provider("$urlRouter", ["$uiRouterProvider", function (t) {
        return t.urlRouterProvider = new ui(t)
    }]), ci.provider("$urlService", di("urlService")), ci.provider("$urlMatcherFactory", ["$uiRouterProvider", function () {
        return pi.urlMatcherFactory
    }]), ci.provider("$templateFactory", function () {
        return new ei
    }), li.provider("$stateRegistry", di("stateRegistry")), li.provider("$uiRouterGlobals", di("globals")), li.provider("$transitions", di("transitionService")), li.provider("$state", ["$uiRouterProvider", function () {
        return he(pi.stateProvider, {
            $get: function () {
                return pi.stateService
            }
        })
    }]), li.factory("$stateParams", ["$uiRouter", function (t) {
        return t.globals.params
    }]), hi.factory("$view", function () {
        return pi.viewService
    }), hi.service("$trace", function () {
        return Me
    }), hi.run(_t), ci.run(["$urlMatcherFactory", function (t) {
    }]), li.run(["$state", function (t) {
    }]), fi.run(["$urlRouter", function (t) {
    }]), si.run(gt);
    ...
    }], It.module("ui.router.state").directive("uiSref", vi).directive("uiSrefActive", gi).directive("uiSrefActiveEq", gi).directive("uiState", yi), Ct.$inject = ["$state"], Pt.$inject = ["$state"], It.module("ui.router.state").filter("isState", Ct).filter("includedByState", Pt);
    var _i;
    _i = ["$view", "$animate", "$uiViewScroll", "$interpolate", "$q", function (t, e, r, n, i) {
        function o(t, r) {
            return {
        ...
        var u = {$cfg: {viewDecl: {$context: t._pluginapi._rootViewContext()}}, $uiView: {}}, s = {
            count: 0, restrict: "ECA", terminal: !0, priority: 400, transclude: "element", compile: function (e, c, f) {
                return function (e, c, l) {
                    function h() {
                        if (d && (Me.traceUIViewEvent("Removing (previous) el", d.data("$uiView")), d.remove(), d = null), m && (Me.traceUIViewEvent("Destroying scope", R), m.$destroy(), m = null), v) {
                            var t = v.data("$uiViewAnim");
                            Me.traceUIViewEvent("Animate out", t), w.leave(v, function () {
                    ...
                    var d, v, m, y, g = l.onload || "", _ = l.autoscroll, w = o(), $ = void 0, S = c.inheritedData("$uiView") || u,
                        b = n(l.uiView || l.name || "")(e) || "$default", R = {
                            $type: "ng1", id: s.count++, name: b, fqn: S.$uiView.fqn ? S.$uiView.fqn + "." + b : b, config: null, configUpdated: function (t) {
                                (!t || t instanceof ti) && (a($, t) || (Me.traceUIViewConfigUpdated(R, t && t.viewDecl && t.viewDecl.$context), $ = t, p(t)))
                            }, get creationContext() {
                                var t = At("$cfg.viewDecl.$context")(S), e = At("$uiView.creationContext")(S);
                                return t || e
                            }
                        };
                    Me.traceUIViewEvent("Linking", R), c.data("$uiView", {$uiView: R}), p(), y = t.registerUIView(R), e.$on("$destroy", function () {
                        Me.traceUIViewEvent("Destroying/Unregistering", R), y()
                    })
                }
            }
        };
    ...
    var wi = "function" == typeof It.module("ui.router").component, $i = 0;
    It.module("ui.router.state").directive("uiView", _i), It.module("ui.router.state").directive("uiView", kt), It.module("ui.router.state").provider("$uiViewScroll", function () {
        var t = !1;
