...
!function (e) {
    ...
    var a = "application/x-dnd", r = "application/json", t = "Text", d = ["move", "copy", "link"]
        ...
        return function (l, f, c) {
            f.attr("draggable", "true"), c.dndDisableIf && l.$watch(c.dndDisableIf, function (e) {
                ...
                if (f.addClass("dndDragging"), i(function () {
                    ...
                    }, 0), s._dndHandle && s.dataTransfer.setDragImage && s.dataTransfer.setDragImage(f[0], 0, 0), e(c.dndDragstart)(l, {event: s}), c.dndCallback) {
