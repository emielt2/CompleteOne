...
angular.module("angular-growl", []), angular.module("angular-growl").directive("growl", [function () {
    ...
    var a = {
        ...
        warning: null,
        info: null
    }, b = "messages", c = "text", d = "title", e = "severity", f = "ttl", g = !0, h = "variables", i = 0, j = !1, k = "top-right", l = !1, m = !1, n = !1, o = !1, p = !0;
    this.globalTimeToLive = function (b) {
        ...
        function v(a) {
            if (H && a.translateMessage)a.text = H(a.text, a.variables) || a.text, a.title = H(a.title) || a.title; else {
                var c = q(a.text);
                a.text = c(a.variables)
            }
            var d = u.addMessage(a);
            return b.$broadcast("growlMessage", a), t(function () {
            }, 0, 1), d
        }
        ...
        function C(a) {
            if (a && a.length) {
                var b, g, i, j;
                for (j = a.length, b = 0; j > b; b++)if (g = a[b], g[c]) {
        ...
        return {warning: x, error: y, info: z, success: A, general: B, addServerMessages: C, onlyUnique: D, reverseOrder: E, inlineMessages: F, position: G}
    }]
    ...
    this.initDirective = function (a, b) {
        ...
        var b = this.getAllMessages(a.referenceId), c = -1;
